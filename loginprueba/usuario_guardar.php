...
if (!empty($email)) {
    ...
    $check_email = conexion()->query("SELECT usuario_email FROM usuarios WHERE usuario_email='$email'");
...
// Verificando usuario
$check_usuario = conexion()->query("SELECT usuario_usuario FROM usuarios WHERE usuario_usuario='$usuario'");
...
// Guardando datos
$guardar_usuario = conexion()->prepare("INSERT INTO usuarios (nombre,apellido,usuario,clave,email) VALUES(:nombre,:apellido,:usuario,:clave,:email)");
